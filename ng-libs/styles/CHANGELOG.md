...
- **styles:** update styles to use material theming

- **.github:** move lint bicep to infra workflow

- **styles:** update style palettes

- **styles:** create `initial-theme` to light & dark styles

- **styles:** wrap initial styles in `.initial-theme` selector
...
- **styles:** create `.splash` style for initial display
...
- **styles:** prevent material errors from m3
